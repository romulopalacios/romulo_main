                ...
                <div className="row">
                            ...
                            <ul className="nav flex-column">
                                ...
                                <li className="nav-item">
                                    ...
                                    <select id="tags" className="form-select">
                                        <option value="tag1">Aprobado</option>
                                        <option value="tag2">En espera</option>
                                    </select>
                                </li>
                            </ul>
                        </div>
                    ...
                    <main className="col-md-9 ms-sm-auto col-lg-9 px-4">
                        <div className="container mt-5">
                            <div className="row">
                                {/* Iterar sobre los proyectos y mostrar cada uno */}
                                {proyectos.map((proyecto, index) => (
                                    <div className="col-md-4 mb-4" key={index}>
                                        <div className="card">
                                            <img src={ejemplo3} className="card-img-top" alt="Proyecto" />
